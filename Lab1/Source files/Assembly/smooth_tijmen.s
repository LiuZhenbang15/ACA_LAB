...
.text
	...
	#Calc norm val for 3 coeffs and setup first and last result
		...
		lw	r1,ones(r0) 				# setup int reg with value 1
		...
		mtc1	r1,f11					#setup float reg with value 1
		and  	r7,r7,r4				# mask sign bit
		mtc1 	r7,f2					# store the coeff as positive float 
		add.d 	f4,f4,f2 				# add absolute value to norm
		...
		s.d	f8,result(r5)			#store the n-1 value in result
	...
	MasterLoop:
		...
		daddi 	r6,r11,-8
		s.d 	f24,result(r16)			# store the result value
